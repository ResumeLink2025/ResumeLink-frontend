...
const ResumeSection = () => {
  ...
  return (
    <div
      className={cn(
        'border rounded-xl mt-6 p-8 flex flex-col gap-14',
        isThemeBlack ? 'bg-gray-70 dark' : 'border-gray-40',
      )}
    >
      ...
      <ActivityList isThemeBlack={isThemeBlack} title="개발 경험" activities={RESUME_RESPONSE.activities} />
