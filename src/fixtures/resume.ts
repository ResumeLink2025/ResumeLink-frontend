export const RESUME_RESPONSE = {
  ...
  categories: ['문제해결 능력 우수', '커뮤니케이션 우수', '꼼꼼함'],
  skills: [
    'HTML',
    'CSS',
    'JavaScript',
  ...
  positions: ['백엔드 개발자', 'DevOps 개발자'],
  projects: [
    {
      title: 'TechBook – 기술 공유 커뮤니티 플랫폼',
      aiDescription: `사용자들이 개발 관련 게시글을 작성하고 북마크할 수 있는 커뮤니티 서비스 구축하였습니다.
    ...
    },
    {
      ...
      aiDescription: `다양한 기업의 채용 데이터를 크롤링 및 통합하여 사용자에게 제공하는 웹 서비스 개발하였습니다.
